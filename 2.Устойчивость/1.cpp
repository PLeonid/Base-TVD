...
//Задание данных
	...
	int const N = 101;		//Размер пространства
	int const M = 50;		//Количество шагов по времени
...
for (L1=-1.3; L1<=1.3; L1=L1+0.1)
{
for (L2=-1.3; L2<=1.3; L2=L2+0.1)
{
...
//Распознование расходящихся решений и вывод
		for (i=0; i<N+1; i++)
		{
			for (j=0; j<N+1; j++)
			{
